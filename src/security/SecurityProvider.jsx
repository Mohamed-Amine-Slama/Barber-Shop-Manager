...
export function SecurityProvider({ children }) {
  ...
  const monitorSuspiciousActivity = () => {
    ...
    const recentCalls = securityLogger.getRecentCalls(60000) 
    ...
    const failedAttempts = securityLogger.getFailedAuthAttempts(300000) 
    if (failedAttempts.length > 5) {
      ...
      rateLimiter.blockTemporarily('auth', 900000) 
    }
  }
