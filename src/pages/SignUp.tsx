      ...
      <div className="flex items-center justify-center p-8 transition-all duration-500 ease-in-out">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">{t("auth.signup.title")}</h1>
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="p-4 border border-border/30 rounded-xl bg-background/50 backdrop-blur-sm focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 placeholder:text-muted-foreground/60"
                    required
                  />
                </div>
                <div className="space-y-2">
              ...
              >
                {loading ? "Creating Account..." : t("auth.signup.submit")}
              </Button>
            </form>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-muted-foreground mb-4">
              ...
              <Link to="/login" className="text-primary hover:text-primary/80 font-semibold transition-colors duration-200">
